...
class ClassificationNetworkColors(torch.nn.Module):
    def __init__(self):
        ...
        self.classes = [
            [-1.0, 0.0, 0.0],  # left
            [-1.0, 0.5, 0.0],  # left and accelerate
            [-1.0, 0.0, 0.8],  # left and brake
            [1.0, 0.0, 0.0],  # right
            [1.0, 0.5, 0.0],  # right and accelerate
            [1.0, 0.0, 0.8],  # right and brake
